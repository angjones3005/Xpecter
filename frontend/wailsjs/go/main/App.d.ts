export function AppendSessionLog(directory: string, sessionId: string, label: string, content: string): Promise<void>;
...
export function AppendSessionLog(arg1:string,arg2:string,arg3:string,arg4:string):Promise<void>;
